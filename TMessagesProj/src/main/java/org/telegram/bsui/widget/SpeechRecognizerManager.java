...
public class SpeechRecognizerManager {
    ...
    public static final String ACTION_SPEAK = "org.telegram.bsui.widget.action.SPEAK";
    public static final String ACTION_CLOSE_RECOGNIZER_ERROR = "org.telegram.bsui.widget.action.CLOSE_RECOGNIZER_ERROR";
    public static final String ACTION_LISTENING_TIMEOUT_END = "org.telegram.bsui.widget.action.LISTENING_TIMEOUT_END";
    ...
    private static SpeechRecognizer createSpeechRecognizer(Context context) {
        Log.d(LOG_TAG, "CreateSpeechRecognizer");
        return SpeechRecognizer.createSpeechRecognizer(context.getApplicationContext());
    }

    private static Intent createRecognizerIntent(Context context) {
        Intent intent = new Intent(RecognizerIntent.ACTION_RECOGNIZE_SPEECH);
        intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE_PREFERENCE, Locale.getDefault());
        intent.putExtra(RecognizerIntent.EXTRA_CALLING_PACKAGE, context.getPackageName());
        intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE_MODEL, RecognizerIntent.LANGUAGE_MODEL_FREE_FORM);
        intent.putExtra(RecognizerIntent.EXTRA_MAX_RESULTS, 1);
        intent.putExtra(RecognizerIntent.EXTRA_SPEECH_INPUT_MINIMUM_LENGTH_MILLIS, 7 * 1000);
        //            BSTelegramWidgetMedium.mIntent.putExtra(RecognizerIntent.EXTRA_SPEECH_INPUT_COMPLETE_SILENCE_LENGTH_MILLIS,
        //                                                                    4 * 1000);
        intent.putExtra(RecognizerIntent.EXTRA_SPEECH_INPUT_POSSIBLY_COMPLETE_SILENCE_LENGTH_MILLIS, 2 * 1000);

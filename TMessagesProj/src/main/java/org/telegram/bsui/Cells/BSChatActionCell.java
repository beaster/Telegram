 ...
 */
public class BSChatActionCell extends BSBaseCell {

    public static interface ChatActionCellDelegate {
        public abstract void didClickedImage(BSChatActionCell cell);
        public abstract void didLongPressed(BSChatActionCell cell);
    ...
    public void setMessageObject(MessageObject messageObject) {
        ...
        if (currentMessageObject.type == 11) {
            ...
            imageReceiver.setVisible(!BSPhotoViewer.getInstance().isShowingImage(currentMessageObject), false);
        } else {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (width != previousWidth) {
            ...
            textLayout = new StaticLayout(currentMessageObject.messageText, textPaint, width - dp(30), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
            textHeight = 0;
            textWidth = 0;
            try {

 ...
 */
public class BSChatMediaCell extends BSChatBaseCell implements MediaController.FileDownloadProgressListener {

    public static interface ChatMediaCellDelegate {
        public abstract void didClickedImage(BSChatMediaCell cell);
        public abstract void didPressedOther(BSChatMediaCell cell);
    }
    ...
    protected void initMedia() {
        if (placeholderDocInDrawable == null) {
            ...
            buttonStatesDrawables[4] = getResources().getDrawable(R.drawable.pause_bs);
    ...
    public void setMessageObject(MessageObject messageObject) {
        ...
        if (currentMessageObject != messageObject || isPhotoDataChanged(messageObject) || dataChanged) {
            ...
            if (messageObject.type == 9) {
                ...
                if (currentInfoString == null || !currentInfoString.equals(str)) {
                    currentInfoString = str;
                    infoOffset = videoIconDrawable.getIntrinsicWidth() + dp(4);
                    infoWidth = (int) Math.ceil(infoPaint.measureText(currentInfoString));
                    infoLayout = new StaticLayout(currentInfoString, infoPaint, infoWidth, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                }
                nameLayout = null;
